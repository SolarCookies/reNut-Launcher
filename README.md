...
In most cases, you only need to configure the `config.ini` file and adjust a few constants in the code (such as the number of backgrounds).
...
- Iso extraction
- Theme customization using the `config.ini`
